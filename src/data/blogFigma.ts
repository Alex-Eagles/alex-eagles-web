...
export const CATEGORY_STYLE: Record<BlogCategory, CategoryStyle> = {
  hardware: {
    ...
    label: { light: "#854F0B", dark: "#D9A65C" },
    badgeText: "#5F3A0A",
  },
  software: {
    ...
    label: { light: "#0F6E56", dark: "#59C79E" },
    badgeText: "#085041",
  },
  firmware: {
  ...
  computerVision: {
    ...
    label: { light: "#993556", dark: "#DD79A0" },
    badgeText: "#4B1528",
  },
  structure: {
    ...
    label: { light: "#5F5E5A", dark: "#B0AB9C" },
    badgeText: "#2C2C2A",
  },
  aerodesign: {
    ...
    label: { light: "#185FA5", dark: "#6AA8E0" },
    badgeText: "#042C53",
  },
  propulsion: {
    ...
    label: { light: "#3B6D11", dark: "#8FC257" },
    badgeText: "#173404",
  },
};
