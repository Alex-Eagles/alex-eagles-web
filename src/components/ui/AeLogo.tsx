 ...
 *
 * The source images live in `src/assets/brand/` (logo-white.png, logo-blue.png)
 * so they're versioned in the repo and bundled by Vite — teammates get them on pull.
 *
